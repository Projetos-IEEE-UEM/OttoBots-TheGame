//Aqui é onde desenharemos uma tela de pause bem simples - Bruno;
var comprimentoTela = display_get_gui_width(); // Comando que pega os dados de dimensões de tela no eixo "x";
var alturaTela = display_get_gui_height(); // Comando que pega os dados de dimensões de tela no eixo "y";
